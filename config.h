...
static char *fonts[]          = { "monospace:size=10:style=Bold", "Noto Sans CJK TC:style=bold:pixelsize=14:antialias=true:autohint=true","Twemoji:pixelsize=13:antialias=true:autohint=true"  };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "VSCodium",  "vscodium",    "Welcome - VSCodium",   0,            0,           0,         0,        -1 },
};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_r,		spawn,		SHCMD("kill -HUP $(pidof -s dwm)") },
	...
	{ MODKEY|ShiftMask,		XK_backslash,		spawn,		SHCMD("kill -36 $(pidof dwmblocks)") },
	...
	{ MODKEY,			XK_c,		spawn,		SHCMD("schedule-ns 3") },
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("schedule-ns 10") },
